"""Tests for services.code_items module"""
...
class FunctionItemTests(TestCase):
    ...
    def test_is_start_with_prefix(self):
        ...
        self.assertFalse(
            FunctionItem({"name": "is_"})._FunctionItem__is_start_with_prefix(
                "is_"
            )
        )

        self.assertFalse(
            FunctionItem({"name": "get_"})._FunctionItem__is_start_with_prefix(
                "get_"
            )
        )
